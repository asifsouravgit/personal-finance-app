...
public class ExpenseAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtExpenseEntryDate = (EditText) findViewById(R.id.expenseEntryDate);

        txtExpenseEntryDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                //Date picker dialog
                picker = new DatePickerDialog(ExpenseAddActivity.this,
                        new DatePickerDialog.OnDateSetListener() {
                            @Override
                            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                                txtExpenseEntryDate.setText(dayOfMonth + "/" + (monthOfYear + 1) + "/" + year);
                            }
                        }, year, month, day);
    ...
    public void btnSaveExpenseClicked(View view) {
        ...
        try {
            ...
            IncomeExpenses incExp = new IncomeExpenses(amountDbl, entryDate, accName, catName, description, 2);
